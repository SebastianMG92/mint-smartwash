...
<div class="relative pt-64 bg-root-blue text-white lg:pb-16">
                    ...
                    ?>
                        <div class="text-center">
                            <figure class="w-10 h-10 mx-auto mb-3 lg:w-16 lg:h-16">
                                <img width="64" height="67" class="object-contain object-center" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                            </figure>
    ...
    <?php if($hero_image): ?>
        <figure class="relative z-0 pointer-events-none w-full max-w-3xl ml-auto lg:absolute lg:bottom-0 lg:right-0 lg:max-w-none lg:w-6/12 xl:w-7/12">
            <img role="presentation" width="850" height="580" class="w-full object-contain object-center" src="<?php echo esc_url($hero_image['url']); ?>" alt="<?php echo esc_attr($hero_image['alt']); ?>" />
        </figure>
    <?php endif; ?>
